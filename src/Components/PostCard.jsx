...
export default function PostCard({ post }) {
  return (
    <div className='group relative w-full sm:w-[300px] lg:w-[280px] h-[340px] border border-teal-500 hover:border-2 overflow-hidden rounded-lg transition-all duration-300'>
